            ...
            <div>
                ...
                <Row gutter={10}>
                    ...
                    <Col className="gutter-row" md={16}>
                        <div className="gutter-box">
                            <Card  bodyStyle={ {padding: '0'}} bordered={false} className="no-padding">
                                <EchartsProjects />
                            </Card>
                        </div>
                    </Col>
                    ...
                    <Col className="gutter-row" md={8}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <span className="card-tool" onClick={this.reflash.bind(this, 1)}><Icon type="sync" /></span>
                                <Timeline>
                    ...
                    <Col className="gutter-row" md={8}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <span className="card-tool" onClick={this.reflash.bind(this, 2)}><Icon type="sync" /></span>
                                <ul className="list-group no-border">
                                    <li className="list-group-item">
                                        <span className="pull-left w-40 mr-m">
                                            <img src="https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png" className="img-responsive img-circle" alt="test" />
                                        </span>
                                        <div className="clear">
                    ...
                    <Col className="gutter-row" md={8}>
                        <div className="gutter-box">
                            <Card bordered={false}>
                                ...
                                <span className="card-tool" onClick={this.reflash.bind(this, 3)}><Icon type="sync" /></span>
                                <EchartsViews />
                            </Card>
                        </div>
                    </Col>
